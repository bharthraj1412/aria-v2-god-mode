export interface DashboardFileState {
  label: string;
  path: string;
  ready: boolean;
  description: string;
...
function renderFileStateCard(fileState: DashboardFileState): string {
...
function renderActionButton(action: DashboardAction): string {
